...
function Footer() {
    return (
        <footer className="m-4">
            <div className="w-full max-w-screen-xl mx-auto p-4 md:pt-36">
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <ul className="flex flex-wrap items-center mb-6 text-sm font-medium sm:mb-0">
                        ...
                        <li>
                            <a href="#" className="hover:underline me-4 md:me-6 text-black">Contact</a>
                        </li>
                        <li>
                            <a href="https://www.linkedin.com/in/yatish-gottapu/" target="_blank" rel="noopener noreferrer" className="hover:underline text-gray-700">LinkedIn</a>
                        </li>
                    </ul>
          ...
          © {new Date().getFullYear()} <a href="/swasthyaSampark/public" className="hover:underline text-black">GEEKS SQUAD@SwaRaksha AI ™</a>. All Rights Reserved.
        </span>
            </div>
        </footer>
    );
