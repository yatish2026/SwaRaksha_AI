                ...
                <div className="relative min-h-screen w-full">
                    ...
                    <div className="relative z-10 min-h-screen flex flex-col py-8 px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="w-full flex justify-center mb-6">
                            <img src="/logo.png" alt="Geeks Squad Logo" className="h-12" />
                        </div>
                        ...
                        <div className="w-full max-w-4xl mx-auto bg-white rounded-xl shadow-2xl overflow-hidden">
                            ...
                            {/* Footer with Icons Above Text */}
                            <footer className="bg-gray-800 text-white py-4 text-center text-xs">
                                <div className="flex justify-center gap-6 mb-2">
                                    <a href="https://www.linkedin.com/in/yatish-gottapu/" target="_blank" rel="noopener noreferrer">
                                        <Linkedin className="w-6 h-6 text-blue-600 hover:text-blue-400" />
                                    </a>
                                    <a href="https://github.com/yatish2026" target="_blank" rel="noopener noreferrer">
                                        <Github className="w-6 h-6 text-black hover:text-gray-600" />
                                    </a>
                                </div>
                                <p>&copy; 2025 Geeks Squad @SwaRaksha AI. All rights reserved.</p>
